  ...
  return (
    <div className="bg-surface dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden" data-calendar-export>
      <div className="p-4 bg-gradient-to-r from-accent to-surface text-gray-800 dark:text-white">
        ...
        <p className="text-gray-700 dark:text-gray-200">Your classes and events at a glance</p>
      </div>

      <div className="overflow-x-auto">
        <div className="min-w-[800px] flex">
          {/* Time column */}
          <div className="w-20 flex-shrink-0 border-r border-border dark:border-gray-700">
            <div className="h-12 border-b border-border dark:border-gray-700"></div>
            {HOURS.map(hour => (
              <div
                key={hour}
                className="h-[60px] border-b border-border dark:border-gray-700 flex items-start justify-end pr-2 pt-1"
              >
          ...
          {/* Days columns */}
          {DAYS.map(day => (
            <div key={day} className="flex-1 border-r border-border dark:border-gray-700 last:border-r-0">
              {/* Day header */}
              <div className="h-12 border-b border-border dark:border-gray-700 flex items-center justify-center bg-muted dark:bg-gray-900">
