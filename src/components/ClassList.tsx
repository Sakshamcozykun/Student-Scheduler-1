...
export const ClassList: React.FC<ClassListProps> = ({
  ...
  if (classes.length === 0) {
    return (
      <div className="bg-surface dark:bg-gray-800 rounded-xl shadow-lg p-8 text-center">
  ...
  return (
    <div className="bg-surface dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
      <div className="p-4 bg-gradient-to-r from-[#FCD5CE] to-[#FAE1DD] text-gray-800">
        <h2 className="text-xl font-bold">All Classes</h2>
        <p className="text-gray-700">Manage your schedule</p>
      </div>
      ...
      <div className="divide-y divide-border dark:divide-gray-700 max-h-96 overflow-y-auto">
        {sortedClasses.map(classSession => (
          <div
            key={classSession.id}
            className="p-4 hover:bg-muted dark:hover:bg-gray-700 transition-colors group"
          >
            <div className="flex items-start justify-between">
              ...
              <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                <button
                  ...
                  className="p-2 text-gray-700 hover:bg-accent dark:hover:bg-blue-900/20 rounded-lg transition-colors"
                  title="Edit class"
                >
