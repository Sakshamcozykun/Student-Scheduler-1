          ...
          <div className="flex items-center space-x-3">
            <div className="relative">
              <button
                ...
                className="px-4 py-2 bg-muted text-gray-800 dark:text-gray-200 rounded-lg hover:bg-border transition-colors text-sm font-medium flex items-center gap-2"
              >
                      ...
                      return (
                        <button
                          ...
                          className={`w-full px-4 py-2 text-left text-sm hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center gap-2 ${
                            currentView === view ? 'bg-gray-100 dark:bg-gray-700 text-accent' : 'text-gray-700 dark:text-gray-300'
                          }`}
                        >
            ...
            <button
              ...
              className="px-4 py-2 bg-muted text-gray-800 rounded-lg hover:bg-border transition-colors text-sm font-medium flex items-center gap-2"
            >
            ...
            <button
              onClick={onAddClass}
              className="px-4 py-2 bg-accent text-white rounded-lg hover:opacity-90 transition-colors text-sm font-medium flex items-center gap-2"
            >
            ...
            <div className="flex items-center space-x-2 border-l pl-3 border-border dark:border-gray-600">
              <div className="relative">
                <button
                  ...
                  className="p-2 text-gray-700 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors"
              ...
              <button
                onClick={onClearAll}
                className="p-2 text-gray-700 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400 transition-colors"
